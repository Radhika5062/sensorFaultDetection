from distutils import dir_util # this is used to read data from utils file. 
...
from scipy.stats import ks_2samp # this is used to check the data drifting
import pandas as pd
import os, sys
...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            # Reading data from both train and test file location
